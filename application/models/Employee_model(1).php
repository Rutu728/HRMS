<?php
  ...
  //performance report 
		...
		public function performancefetch(){ 
      $sql = "SELECT performance.*, employee.em_id, first_name, last_name, em_code 
			FROM performance 
			LEFT JOIN employee ON performance.em_id = employee.em_id;
			"; 
        $query=$this->db->query($sql); 
  $result = $query->result(); 
  return $result;         
    ...
    public function DeletPerformance($id){ 
      $this->db->delete('performance',array('id'=> $id)); 
  } 
    ...
    public function GetPerformanceValue($id){ 
    ...
    //resignation
		...
		public function resignationfetch(){
      $sql = "SELECT `resignation`.*, `employee`.`em_id`, `first_name`, `last_name`, `em_code`
			FROM `resignation`
			LEFT JOIN `employee` ON `resignation`.`em_id` = `employee`.`em_code`";
        $query=$this->db->query($sql);
		$result = $query->result();
		return $result;        
    }

		public function GetResignValue($id){
			$sql = "SELECT * FROM `resignation` WHERE `id`='$id'";
			$query = $this->db->query($sql);
			$result = $query->row();
			return $result; 
	} 
	...
	public function DeletResignation($id){
		$this->db->delete('resignation',array('id'=> $id));
	}

	public function Update_Resignation($em_id,$data){
