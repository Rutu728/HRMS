...
class Attendance_model extends CI_Model
{
    ...
    public function AttendanceRecordsForEmployee($emid) {
    // Construct SQL query to select attendance records for the given employee ID
    $sql = "SELECT `emp_id`, `atten_date`, `signin_time`, `signout_time`, `working_hour`
            FROM `attendance`
            WHERE `emp_id` = ?";
