...
<head>
    ...
    <meta name="author" content="MountainHigh">
    <!-- Favicon icon -->
	...
	<link rel="icon" type="image/png" sizes="32x32" href="<?php echo base_url(); ?>assets/images/mfavicon-32x32.png">
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper" >
        <header class="topbar" style="background: linear-gradient(89deg, rgb(21, 74, 189) 0.1%, rgb(26, 138, 211) 51.5%, rgb(72, 177, 234) 100.2%);">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
					<!-- <img src="<?php echo base_url();?>assets/images/logo1.jpg" alt="DRI" class="DRI-logo" style="width:190px; height:80px; margin-bottom: 0px; object-fit: contain;"/> -->


                        </b>
                        <!-- Logo text --><span>
                         <img src="<?php echo base_url(); ?>assets/images/<?php echo $settingsvalue->sitelogo; ?>" alt="homepage" class="logo1"  width="120px" style="margin-top:50px; scale:1.17"/>
                         <!-- Light Logo text -->    
                         </span> </a>
                </div>
