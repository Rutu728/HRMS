        <aside class="left-sidebar" style="background: linear-gradient(89deg, rgb(21, 74, 189) 0.1%, rgb(26, 138, 211) 51.5%, rgb(72, 177, 234) 100.2%);" >
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar" >
                <!-- User profile -->
                        ...
                        ?>                
                <div class="user-profile" style="margin-top:50px; background: linear-gradient(89deg, rgb(21, 74, 189) 0.1%, rgb(26, 138, 211) 51.5%, rgb(72, 177, 234) 100.2%);" >
                    <!-- User profile image -->
                ...
                <!-- Sidebar navigation-->
                <nav class="sidebar-nav" style="background: linear-gradient(89deg, rgb(21, 74, 189) 0.1%, rgb(26, 138, 211) 51.5%, rgb(72, 177, 234) 100.2%);">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Employee </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li> <a  href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>" aria-expanded="false"><i class="mdi "></i><span class="hide-menu">Employee Details </span></a>
                                </li>
                                <li><a href="<?php echo base_url(); ?>attendance/EmAttendance"> Attendance </a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-building-o"></i><span class="hide-menu">Organization </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url();?>organization/Offboarding">Offboarding</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Reports</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>incident/Incident">Incident Report</a></li>
                                <li><a href="<?php echo base_url(); ?>employee/Performance">Performance Report</a></li>
                                <li><a href="<?php echo base_url(); ?>employee/Inactive_Employee">Inactive User </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-cash"></i><span class="hide-menu">Billing</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>invoicebill/Invoicebill">Invoice</a></li>
                                <li><a href="<?php echo base_url(); ?>expense/Expense">Expenses</a></li>
                                <li><a href="<?php echo base_url(); ?>quotation/Quotation">Quotation</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file-check"></i><span class="hide-menu">Policies</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li> <a href="<?php echo base_url()?>policies/Policies" ><span class="hide-menu">Company Policies <span class="hide-menu"></a></li>
                            </ul>
                        </li>
